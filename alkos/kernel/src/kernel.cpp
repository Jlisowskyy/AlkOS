...
static inline uint8_t vga_entry_color(vga_color fg, vga_color bg) { return fg | bg << 4; }
...
static inline void terminal_initialize()
{
    terminal_row    = 0;
    terminal_column = 0;
...
static inline void terminal_writestring(const char *data) { terminal_write(data, strlen(data)); }
